// File: components/order/EnhancedAddressCard.tsx
...
const EnhancedAddressCard: React.FC<AddressCardProps> = ({
    ...
    return (
        <>
            <motion.div
                className={`relative border rounded-lg p-4 mb-3 cursor-pointer shadow-sm ${
                    selected
            ...
            >
                {isDefault && (
                    <div className="absolute top-0 right-0 w-0 h-0 border-t-[40px] border-r-[40px] border-t-transparent border-r-primary/80">
                            ...
                            <AnimatePresence>
                                {showActions && (
                                    <motion.div
                                        ...
                                        className="absolute top-full right-0 mt-2 w-36 bg-white dark:bg-gray-800 rounded-lg shadow-lg z-10 overflow-hidden"
