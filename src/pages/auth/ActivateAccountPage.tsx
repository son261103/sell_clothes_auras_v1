...
const ActivateAccountPage: React.FC = () => {
    ...
    // Ngăn chặn quay lại trang đăng nhập bằng cách vô hiệu hóa nút back của trình duyệt
    useEffect(() => {
        const preventBack = () => {
    ...
    // Lấy email từ localStorage hoặc user context
    useEffect(() => {
