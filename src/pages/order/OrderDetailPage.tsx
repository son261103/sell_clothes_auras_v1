...
import {
    ...
    FiClock, FiFileText, FiSend, FiPhone,
    FiInfo, FiChevronRight, FiArrowLeft
} from 'react-icons/fi';
                    ...
                    >
                        ...
                        <div className="mb-4">
                            ...
                            <textarea
                                id="cancelReason"
                                rows={3}
                                className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-accent focus:border-primary dark:focus:border-accent"
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
                <input
                    type="text"
                    className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white mb-4 focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-accent focus:border-primary dark:focus:border-accent"
                ...
                <div className="flex justify-end space-x-3">
                    ...
                    <button
                        type="submit"
                        className="px-4 py-2 bg-primary dark:bg-accent hover:bg-primary/90 dark:hover:bg-accent/90 text-white rounded-lg transition-colors"
                    >
                        Xác nhận
                    </button>
                </div>
...
const OrderDetailPage: React.FC = () => {
    ...
    const getPaymentStatusInfo = (status: string) => {
        switch (status) {
            ...
            case PaymentStatus.PENDING:
                return {
                    icon: <FiClock className="w-5 h-5 text-yellow-500 dark:text-yellow-400" />,
            ...
            default:
                return {
                    icon: <FiAlertCircle className="w-5 h-5 text-gray-500 dark:text-gray-400" />,
                    text: 'Chưa xác định',
    ...
    const paymentStatusInfo = payment
        ...
        : { icon: <FiCreditCard className="w-5 h-5 text-gray-500 dark:text-gray-400" />, text: 'Chưa thanh toán', color: 'text-gray-600 dark:text-gray-400' };
        ...
        <div className="min-h-screen">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-7xl">
                ...
                >
                    ...
                    <Link to="/order/list" className="hover:text-primary dark:hover:text-accent transition-colors">
                        Đơn hàng của tôi
                    </Link>
                    <FiChevronRight className="mx-2 w-4 h-4 flex-shrink-0" />
                ...
                <motion.button
                    ...
                    data-aos="fade-right"
                >
                    <FiArrowLeft className="mr-2 w-5 h-5" /> Quay lại danh sách đơn hàng
                </motion.button>
                ...
                >
                    ...
                    <div className="mt-3 sm:mt-0">
                        <span className={`px-3 py-1 rounded-lg text-sm font-medium ${getStatusBadgeColor(order.status)}`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        >
                            <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white flex items-center">
                                <div className="bg-primary/10 dark:bg-accent/20 p-2 rounded-full mr-2">
                                    <FiClock className="w-5 h-5 text-primary dark:text-accent" />
                                </div>
                                Trạng thái đơn hàng
                            </h2>
                        ...
                        >
                            <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white flex items-center">
                                ...
                                Sản phẩm đã đặt ({displayItems.length})
                            </h2>
                        ...
                        {isCodeMethod && order.status === OrderStatus.SHIPPING && (
                            <motion.div
                                ...
                                className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-primary/20 dark:border-accent/20 border-l-4 border-l-primary dark:border-l-accent"
                                data-aos="fade-up"
                                data-aos-delay="250"
                            >
                                <div className="flex items-start">
                                    <FiSend className="mt-1 mr-3 text-primary dark:text-accent flex-shrink-0 w-5 h-5" />
                                    <div className="flex-1">
                                        ...
                                        <motion.button
                                            ...
                                            className="px-4 py-2 bg-primary hover:bg-primary/90 dark:bg-accent dark:hover:bg-accent/90 text-white rounded-lg transition-colors shadow-sm"
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.5, delay: 0.1 }}
                            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 sticky top-6"
                            data-aos="fade-left"
                            data-aos-delay="100"
                        >
                            <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white flex items-center">
                                <div className="bg-primary/10 dark:bg-accent/20 p-2 rounded-full mr-2">
                                    <FiFileText className="w-5 h-5 text-primary dark:text-accent" />
                                </div>
                                Tóm tắt đơn hàng
                            </h2>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                                    ...
                                    <div className="flex justify-between py-3 text-base font-semibold">
                                        ...
                                        <span className="text-primary dark:text-accent">{formatPrice(order.totalAmount)}</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                {orderCancelled ? (
                                    <button
                                        className="w-full px-4 py-2 bg-red-100 dark:bg-red-900/20 text-red-500 rounded-lg cursor-not-allowed"
                                        disabled={true}
                                    >
                                        Đã hủy
                                    </button>
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    onClick={() => navigate('/order/list')}
                                    className="w-full px-4 py-2 bg-primary hover:bg-primary/90 dark:bg-accent dark:hover:bg-accent/90 text-white rounded-lg transition-colors shadow-sm"
                                >
                                    Xem tất cả đơn hàng
                                </motion.button>
                            </div>
